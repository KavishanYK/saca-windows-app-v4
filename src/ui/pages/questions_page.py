...
class QuestionsPage(QWidget):
    ...
    def __init__(self):
        ...
        _divider.setStyleSheet("background: qlineargradient(x1:0,y1:0,x2:1,y2:0, stop:0 #8B3A2E, stop:1 transparent); border:none; border-radius:2px;")
        ...
        self.scale_title.setAlignment(Qt.AlignLeft)
